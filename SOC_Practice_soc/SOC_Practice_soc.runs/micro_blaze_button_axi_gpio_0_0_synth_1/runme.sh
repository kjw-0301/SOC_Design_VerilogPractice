...
HD_PWD='C:/Users/minkyu/Documents/GitHub/SOC_Design_VerilogPractice/SOC_Practice_soc/SOC_Practice_soc.runs/micro_blaze_button_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log micro_blaze_button_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source micro_blaze_button_axi_gpio_0_0.tcl
