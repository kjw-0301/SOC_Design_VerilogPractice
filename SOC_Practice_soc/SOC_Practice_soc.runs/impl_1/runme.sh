...
HD_PWD='C:/Users/minkyu/Documents/GitHub/SOC_Design_VerilogPractice/SOC_Practice_soc/SOC_Practice_soc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log micro_blaze_FND_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source micro_blaze_FND_wrapper.tcl -notrace
